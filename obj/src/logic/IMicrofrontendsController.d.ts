...
export interface IMicrofrontendsController {
    ...
    getMicrofrontendById(correlationId: string, microfrontend_id: string, callback: (err: any, microfrontend: MicrofrontendV1) => void): void;
    ...
    deleteMicrofrontendById(correlationId: string, microfrontend_id: string, callback: (err: any, microfrontend: MicrofrontendV1) => void): void;
}
