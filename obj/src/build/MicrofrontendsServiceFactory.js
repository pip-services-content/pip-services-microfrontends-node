...
class MicrofrontendsServiceFactory extends pip_services3_components_node_1.Factory {
    constructor() {
        super();
...
MicrofrontendsServiceFactory.Descriptor = new pip_services3_commons_node_1.Descriptor("pip-services-microfrontends", "factory", "default", "default", "1.0");
MicrofrontendsServiceFactory.MemoryPersistenceDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-microfrontends", "persistence", "memory", "*", "1.0");
MicrofrontendsServiceFactory.FilePersistenceDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-microfrontends", "persistence", "file", "*", "1.0");
MicrofrontendsServiceFactory.MongoDbPersistenceDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-microfrontends", "persistence", "mongodb", "*", "1.0");
MicrofrontendsServiceFactory.ControllerDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-microfrontends", "controller", "default", "*", "1.0");
MicrofrontendsServiceFactory.HttpServiceDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-microfrontends", "service", "http", "*", "1.0");
MicrofrontendsServiceFactory.CommandableGrpcServiceDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-microfrontends", "service", "commandable-grpc", "*", "1.0");
MicrofrontendsServiceFactory.GrpcServiceDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-microfrontends", "service", "grpc", "*", "1.0");
