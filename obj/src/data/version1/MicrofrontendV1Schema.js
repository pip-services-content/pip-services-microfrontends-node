...
class MicrofrontendV1Schema extends pip_services3_commons_node_1.ObjectSchema {
    constructor() {
        super();
        ...
        this.withRequiredProperty('path_prefix', pip_services3_commons_node_2.TypeCode.String);
        ...
        this.withRequiredProperty('remote_entry', pip_services3_commons_node_2.TypeCode.String);
        this.withRequiredProperty('exposed_module', pip_services3_commons_node_2.TypeCode.String);
        this.withRequiredProperty('element_name', pip_services3_commons_node_2.TypeCode.String);
