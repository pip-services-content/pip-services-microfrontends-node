...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-microfrontends-node": "^1.1.*",
        ...
    }
}
```
...
var plugin = new require('pip-services-microfrontends-node').MicrofrontendsSenecaPlugin;
...
or by using [MicrofrontendsSenecaClient](https://github.com/pip-services-content/pip-clients-microfrontends-node/doc/NodeClientApiV1.md/#client_seneca)